...
@section('container')
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="form-group col-md-2">
                                        <button class="btn btn-success" style="margin-top:31px"
                                            onclick="cari_riwayat_PO()"><i class="bi bi-search ml-1 mr-1"></i>Cari
                                            riwayat</button>
                                    </div>
                                </div>
                            </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            cari_riwayat_PO(awal, akhir)
        })
        function cari_riwayat_PO(awal = $('#tanggalawal').val(),akhir = $('#tanggalakhir').val()){
            spinner = $('#loader2')
            spinner.show();
            $.ajax({
                type: 'post',
                ...
                success: function(response) {
                    spinner.hide();
                    $('.v_tabel_riwayat_po').html(response);
                }
            });
        }
    </script>
